/*==========================================================
 *
 *    Purpose: Conversion of BCD code to Excess3 code.
 *                                                          
 *=========================================================*/
...
int main(void)
{
    ...
    PyHal_GPIO_SetDir(19,1);
    PyHal_GPIO_SetDir(20,1);
    ...
    PyHal_GPIO_SetDir(27,0);
    PyHal_GPIO_SetDir(28,0);
	uint32_t a,b,c,d,w,x,z,y,p;
    while(1)
    {	
        //Test GPIO Code
    a=PyHal_GPIO_Get(25);//LSB
    b=PyHal_GPIO_Get(26);
    c=PyHal_GPIO_Get(27);
    d=PyHal_GPIO_Get(28);//MSB
...
void sevenseg(int n){
	switch (n){
		case 0: disp(0,0,0,0,0,0,1);
		break;
		case 1: disp(1,0,0,1,1,1,1);
		break;
		case 2: disp(0,0,1,0,0,1,0);
		break;
		case 3: disp(0,0,0,0,1,1,0);
		break;
		case 4: disp(1,0,0,1,1,0,0);
		break;
		case 5: disp(0,1,0,0,1,0,0);
		break;
		case 6: disp(1,1,0,0,0,0,0);
		break;
		case 7: disp(0,0,0,1,1,1,1);
		break;
		case 8: disp(0,0,0,0,0,0,0);
		break;
		case 9: disp(0,0,0,1,1,0,0);
		break;
		
		default: disp(1,1,1,1,1,1,1);
		break;
