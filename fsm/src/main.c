...
int main(void)
{
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(21,1);//y
    PyHal_GPIO_SetDir(22,1);//b0
    PyHal_GPIO_SetDir(23,1);//b1
    PyHal_GPIO_SetDir(24,1);//clk
    PyHal_GPIO_SetDir(25,0);//x
    PyHal_GPIO_SetDir(26,0);//a0
    PyHal_GPIO_SetDir(27,0);//a1
	uint32_t x,y,a0,a1,b0,b1,clk;
    while(1)
    {	
    PyHal_GPIO_Set(24,0);
    ...
    x=PyHal_GPIO_Get(25);
    PyHal_GPIO_Set(24,1);
    a0=PyHal_GPIO_Get(26);
    a1=PyHal_GPIO_Get(27);
    ...
    PyHal_GPIO_Set(21,y);
    PyHal_GPIO_Set(22,b0);
    PyHal_GPIO_Set(23,b1);
 HAL_DelayUSec(1000000);
    }
